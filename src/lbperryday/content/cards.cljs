...
(def no-more-cards {:title "NO MORE CARDS"
                    :body "You have drawn the last card. Whoever's in first place is declared the victor. Before the next game, please consider expanding the deck by creating new cards to play."})
...
(def cards [{:num 1
             ...
             :body "Coldplay decides to play a surprise concert on Friday evening somewhere within a three hour drive of LBP. If you're playing as Sam, lose a turn unless you're currently eating raw cookie dough, in which case, take another bite of cookie dough and roll again."}
            {:num 2
            ...
            {:num 17
             ...
             :body "While you thought you would beat the LBP traffic this year by arriving at noon on Thursday, it turns out everyone else spent Wednesday night in Chase's back yard and got there before you. Lose a turn trying to figure out where you're going to sleep, unless you're playing as Garner, in which case demonstrate that you can sleep anywhere by planking ridiculously, and then roll again."}
            {:num 18
            ...
            {:num 21
             ...
             :body "Minding your own business after going all-in pre-flop on 3-7o (and winning on a flop that had a 4, turn of 5, and river of 6), Red Phil challenges you to a One Step. It quickly escalates to EVERYONE being challenged to One Step. Quickly, everyone quote a unique line from \"No Retreat, No Surrender\" (going from last place to first, age as tie-breaker) to help diffuse the situation. Anyone failing to do so moves back a space, including Phil."}
            {:num 22
             :title "Authorship"
            ...
            {:num 24
             :title "Daytona!"
             :body "Rusty comes through with a set of four full-sized multi-linked Daytona cabinets, only he's having some trouble getting them out of the U-haul and into the house. If you're playing as Rusty, lose a turn running back an forth with a dolly (wooden?), unless you can convince three other players to help you, in which case you all take a drink and you roll again."}
            {:num 25
            ...
            {:num 47
             :title "Dodge It!"
             :body "Summarize the context for the title of this card. Demonstrate the nice moves associated with it. Say the appropriate line(s) while demonstrating. Judgement (by simple majority) of the entertainment value of the actions determines whether or not you get to roll again."}
            {:num 48
             :title "Witch's Brew"
